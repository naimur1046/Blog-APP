        ...
        <div className="flex justify-center space-x-6 mr-0">
          <div className="mb-6 ml-40 mr-20">
            <div className="flex items-left">
              ...
              <p className="text-3xl text-logoColortext m-0 p-0 font-bold">
                SOURCE Blog
              </p>
            </div>
          </div>
          <div className="mr-0 flex flex-row space-x-5  ">
            <div>
              ...
              <ul className="text-gray-500 font-medium">
                ...
                <li>
                  <p className="">01611300900, 0821724098</p>
                </li>
              </ul>
            </div>
            <div>
              ...
              <ul className="text-gray-500 font-medium">
                <li className="mb-4">
                  <p>7/5, Aurongzeb Road, Mohammadpur, Dhaka.</p>
                </li>
                <li>
                  <p>01811458537</p>
                </li>
            ...
            <div className="pl-5 ">
              ...
              <ul className="text-gray-500 font-medium">
                ...
                <li>
                  <a
                    className="hover:underline"
                    href="https://www.instagram.com/palestineredcrescent/"
                  >
                    Instragram
                  </a>
                </li>
